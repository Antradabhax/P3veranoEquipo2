public class BinarySearchTree {
    ...
    //metodo para buscar un valor en el BST
    ...
    static private int getTreeHeight(TreeNode root) {
        if (root == null) {
            return 0;
        }

        int alturaIzq = getTreeHeight(root.left);
        int alturaDer = getTreeHeight(root.right);
